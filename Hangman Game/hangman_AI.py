...
class HangmanGUI:
    def __init__(self, root):
        ...
        self.root.geometry("600x700") # increased window size to accommodate new functionality
    ...
    def new_game(self):
        ...
        self.word_label.grid(row=0, column=0, columnspan=13, pady=20, sticky='nsew')

        self.turns_label = tk.Label(self.root, text=f"Turns left: {self.turns}", font=("Arial", 14))
        self.turns_label.grid(row=1, column=0, columnspan=13, pady=10, sticky='nsew')

        self.message_label = tk.Label(self.root, text="", font=("Arial", 14), height = 3)
        self.message_label.grid(row=7, column=0, columnspan=13, sticky='nsew') # changed the row to put this box below the buttons
        ...
        self.replay_button = tk.Button(self.root, text="Replay", command=self.new_game, font=("Arial", 14))
        self.replay_button.grid(row=3, column=0, columnspan=13, pady=10, sticky='nsew')
        ...
        for letter in alphabet:
            ...
            #keyboard binding
            self.root.bind(letter, lambda event, l = letter: self.make_guess(l)) # added keyboard input
            col += 1
            if col > 12:
               col = 0
               row += 1
    ...
    def end_game(self, win):
        ...
        self.new_game() # Restart the game after completion
